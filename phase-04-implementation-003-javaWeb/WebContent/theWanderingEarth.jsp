...
<script>
	function run(clickedObj) {
		...
		$(clickedObj).animate({
			width : '10px',
			opacity : '0',
			backgroundPositionX : '1800px',
			backgrounfPositionY : '1800px',
			bottom : '10px'
		}, 12000);
		//$('#waiting')[0].play();
		$("#moviebox").show('slow');
...
<body class="background1">
	...
	<div id="poem-txt"
		style="display: none; font-size: 22px; color: blue; position:absolute; left :10px;top:50px" >
	...
	<img src="/static/imgs/earth.png"
		style="position: absolute; left: 100px; bottom: 100px; width: 200px"
